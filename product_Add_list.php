...
if (isset($_GET['id'])) {
    ...
    if ($conn->query($sql)) {
        header('location: product_Add_list.php');
    }
}
?>
<!DOCTYPE html>
            ...
            <ul class="ber">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="product_Add_list.php">Product List</a></li>
                </ul>
              </div>
            </ul>
          </div>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td><?= $row['price']; ?></td>
                                <td>
                                    <img src="<?= $row['photo']; ?>" width="100px" height="120px">
                                </td>
                                
                                <td>
                                    <a href="product_Add_list_id?id=<?= $row['id']; ?>">Edit</a>
                                    <a onclick="return confirm('Are you sure?')"
                                        href="product_Add_list.php?id=<?= $row['id']; ?>">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
