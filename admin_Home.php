...
<body>
  ...
  <div id="carouselExampleCaptions" class="carousel slide sideshow" data-bs-ride="carousel">
    ...
    <div class="carousel-inner slide ">
      <div class="carousel-item active" data-aos="zoom-out" data-aos-delay="100">
        ...
        <p class="event-p">The moment is now. Drive home with a great offer on our 2024 Outlander and the 2024 Outlander
          Plug-in Hybrid during the Mitsubishi Summer Sales Event.</p>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 shop" data-aos="zoom-left" data-aos-delay="100">
          ...
          <p>It's easy. Shop for the perfect car for your budget without impacting your credit score. Once you
            prequalify, see real rates and payments on many vehicles near you.</p>
          <button>
            <a href="u_Shop_Online.php">START SHOPPING</a></button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="show_button">
    <ul>
      <li>
        <button>
          <a href="u_Shop_Online.php">Show More</a>
        </button>
      </li>
    </ul>
  </div>
