  ...
  <div class="col-lg-4 mt-3 mb-3">
    <div class="card-deck">
      <div class="card border_info p-2  ">
        ...
        <a href="a_product_order_list.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-block btn-lg  ">Buy Now</a>
      </div>
    </div>
  </div>
  ...
  <div class="feature">
    <div class="feature-1">
      ...
      <ul>
        ...
        <li>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur, eligendi dolorum cum explicabo
            necessitatibus odit quo nostrum culpa amet neque, aliquid magnam aliquam! Facilis numquam aliquid, error
            laborum voluptate doloremque!</p>
        </li>
      </ul>
    </div>
  </div>
